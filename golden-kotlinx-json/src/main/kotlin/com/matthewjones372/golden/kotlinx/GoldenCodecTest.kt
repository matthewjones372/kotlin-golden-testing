...
/**
 * Main entry point for golden codec testing with kotlinx.serialization.
...
suspend fun <T> goldenCodecTest(
    ...
    val fileManager = GoldenFileManager(typeName, config.resourcePath, "json")
    val laws = GoldenCodecLaws(json, serializer, fileManager)
