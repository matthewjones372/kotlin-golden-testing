...
class GoldenCodecLaws<T>(
    ...
    fun goldenDecodingLaw(index: Int): Boolean {
        ...
        val decoded: T = mapper.readValue(goldenJson, goldenFileManager.typeReference)
    ...
    fun roundTripLaw(value: T): Boolean {
        ...
        val decoded: T = mapper.readValue(json1, goldenFileManager.typeReference)
